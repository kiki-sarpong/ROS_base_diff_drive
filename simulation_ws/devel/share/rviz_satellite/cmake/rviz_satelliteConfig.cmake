...
if("TRUE" STREQUAL "TRUE")
  set(rviz_satellite_SOURCE_PREFIX /home/kiki/github_files/simulation_ws/src/rviz_satellite)
  set(rviz_satellite_DEVEL_PREFIX /home/kiki/github_files/simulation_ws/devel)
  ...
  set(rviz_satellite_INSTALL_PREFIX /home/kiki/github_files/simulation_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "https://github.com/nobleo/rviz_satellite " STREQUAL " ")
    set(_report "Check the website 'https://github.com/nobleo/rviz_satellite' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Tim Clephas <tim.clephas@nobleo.nl>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rviz_satellite' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kiki/github_files/simulation_ws/src/rviz_satellite/${idir}'.  ${_report}")
    endif()
...
set(depends "roscpp;rviz;sensor_msgs")
